...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Không cho trang phía sau scroll khi popup đang mở
    ...
    <>
          ...
          >
            ...
            >
              ...
              <button
                type="button"
                onClick={openVideo}
                aria-label="Xem video dự án Nam Mekong Grand Plaza"
      ...
      {isVideoOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Video Nam Mekong Grand Plaza"
        >
          {/* =================================================
              CLOSE BUTTON
          ================================================= */}
          ...
          <button
            ...
            className="absolute right-4 top-4 z-20 flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-xl transition-all duration-300 hover:rotate-90 hover:bg-white hover:text-[#08111F] sm:right-6 sm:top-6"
          >
            <X size={24} />
          </button>
          ...
          <div className="relative w-full max-w-6xl overflow-hidden rounded-2xl border border-white/10 bg-black shadow-[0_30px_100px_rgba(0,0,0,0.6)] sm:rounded-3xl">
